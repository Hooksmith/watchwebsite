(function() {
    app.controller('HotelCreateCtrl', function($scope, uiGmapGoogleMapApi,
        ...
        $scope.chooseFile = function(filetmp, callback) {
            ...
            var url = $rootScope.remoteUrl + '/v1/admin/recommendations/' + $scope.data._id + '/webb';
            ...
            $scope.upload = Upload.upload({
                ...
                if (filetmp.type == 'gallery') {
                    ...
                    if ($scope.data.webb == null)
                        $scope.data.webb = {};
                    $scope.data.webb.thumbnail_url_link = filetmp.src;
        ...
        function loadData() {
            $rootScope.loading('show');
            $scope.data = CoResource.resources.Recommendation
                .get({
                    recId: $scope._id || 'NO_DATA'
                }, function(s) {
                    $scope.loading = false;
